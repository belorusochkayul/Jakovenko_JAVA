...
public class AlfaBank extends Bank implements BankName, AtmManufacturer, AddMoney, EnterSumWithdraw, WithdrawMoney {

    private final static String NameBank = "AlfaBankk";
